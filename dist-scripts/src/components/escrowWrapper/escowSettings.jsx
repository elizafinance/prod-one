...
const EscrowSettings = () => {
    ...
    return (<Card className="flex flex-col flex-1 min-h-[300px] p-8 gap-4">
      <div className="text-xl">Escrow Settings</div>

      {!escrowAddress && (<div className="flex flex-1 flex-col justify-center w-full items-center">
          <div className="text-red-500">Escrow address not set in env</div>
        </div>)}
      {escrowData && (<div className="flex flex-col gap-2 w-full">
          <div>
