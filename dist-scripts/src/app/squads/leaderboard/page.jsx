    ...
    useEffect(() => {
        const fetchSquadLeaderboard = async () => {
            ...
            try {
                ...
                setError(err.message || 'Could not load squad leaderboard.');
                console.error(err);
            }
            setIsLoading(false);
        };
            ...
            <table className="min-w-full">
              ...
              <tbody className="divide-y divide-gray-200">
                ...
                if (rank === 1)
                    ...
                    rowClasses = "bg-slate-100 hover:bg-slate-200";
                else if (rank === 3)
                    rowClasses = "bg-orange-50 hover:bg-orange-100";
                return (<tr key={squad.squadId} className={rowClasses} onClick={() => router.push(`/squads/${squad.squadId}`)} style={{ cursor: 'pointer' }}>
