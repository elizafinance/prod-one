...
export async function GET(request) {
    ...
    try {
        ...
        const inviterUsers = await usersCollection.find({ walletAddress: { $in: inviterWallets } }, { projection: { walletAddress: 1, xUsername: 1, xProfileImageUrl: 1, _id: 0 } }).toArray();
        // Create a map for quick lookup
        const inviterUserMap = new Map();
